...
<div class="row">
	<div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6">
		...
		?>
		<div class="row">
			<div class="col-xs-2 col-md-1"><img src="../res/image/diary/meal<?php echo $meal; ?>.png" width="50px" onclick="change_stats(<?php echo $meal; ?>)" class="position: inherit; "></div>
			<div class="col-xs-10 col-md-11">
				<div id="meal<?php echo $meal; ?>tool" style="display: none; padding-top: 0px; padding-bottom: 0px; position: inherit; margin-top: 12px; margin-left: -6px;" class="jumbotron">
		...
		<div class="row">
			<div class="col-md-12">
				<div id="meal<?php echo $meal; ?>food" style="display: none; text-align: center; padding-top: 10px; padding-bottom: 10px; position: inherit; margin-top: -35px; margin-left: 25px; margin-right: 10px; z-index: -1;" class="jumbotron">
				<?php
				$query = new query;
				$query->table = "diary";
				$query->where = array(
